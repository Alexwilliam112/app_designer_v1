...
export default function FeaturePanel() {
  ...
  return (
    <Panel position="top-right" className="w-fit text-xs">
      <Form {...form}>
        <form
          className="flex flex-col p-4 gap-2 bg-muted w-[25vw] 3xl:w-[16vw] shrink-0 h-[96vh] border rounded-xl overflow-hidden"
          onSubmit={form.handleSubmit(onSubmit)}
        >
          <header className="flex justify-between pb-2 border-b border-foreground/30 shrink-0">
            <div className="flex gap-2 items-center">
              {featureIcon}
              <h1 className="leading-none text-lg font-semibold">
          ...
          <div className="grid grid-rows-2 gap-2 min-h-0 h-fit">
            <div className="flex flex-col gap-2 pb-2 border-foreground/30">
              <h2 className="font-semibold text-foreground/80 leading-none">Featues</h2>
              <div className="flex flex-col gap-1 overflow-y-auto flex-1 min-h-0">
                <Command className="border">
                  <CommandInput
                    className="text-xs h-fit"
                    placeholder="Search data source component"
                  />
                  <CommandList>
                          ...
                          render={({ field }) => {
                            ...
                            return (
                              <CommandItem key={item.id} className="flex items-center gap-2 p-0">
                                <FormItem
                                  key={item.id}
                                  className="flex gap-2 items-center w-full p-1"
                                >
                                  <FormControl>
                                    <div className="items-center flex h-4 w-4">
                                      <Checkbox
                                        className="w-5 h-5 bg-background shadow-none"
                                        checked={isChecked}
